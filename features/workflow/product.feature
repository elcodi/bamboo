...
Feature: Product engine
  ...
  Scenario: Create a product with variant
    ...
    And I fill in the following:
      | elcodi_admin_form_type_product_name_en_name               | Product x     |
      | elcodi_admin_form_type_product_description_en_description | Description x |
      | elcodi_admin_form_type_product_principalCategory          | 1             |
      | elcodi_admin_form_type_product_manufacturer               | 1             |
      | elcodi_admin_form_type_product_price_amount               | 10            |
    And I check "elcodi_admin_form_type_product_showInHome"
    And I check "elcodi_admin_form_type_product_enabled"
    ...
    And I fill in the following:
      | elcodi_admin_form_type_product_variant_price_amount | 12 |
    And I check "elcodi_admin_form_type_product_variant_enabled"
