...
namespace Elcodi\Fixtures\DataFixtures\ORM\Base\Shipping;
 ...
 * Class CarriersData
 */
class CarriersData extends AbstractFixture implements DependentFixtureInterface
{
    /**
    ...
    {
        return [
            'Elcodi\Fixtures\DataFixtures\ORM\Base\Tax\TaxData',
        ];
    }
}
