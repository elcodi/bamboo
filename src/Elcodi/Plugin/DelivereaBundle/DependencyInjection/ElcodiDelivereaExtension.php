...
namespace Elcodi\Plugin\DelivereaBundle\DependencyInjection;
...
/**
 * Class ElcodiDelivereaExtension
 */
class ElcodiDelivereaExtension extends AbstractExtension implements EntitiesOverridableExtensionInterface
{
    /**
     * @var string
     *
     * Extension name
     */
    const EXTENSION_NAME = 'elcodi_deliverea';
