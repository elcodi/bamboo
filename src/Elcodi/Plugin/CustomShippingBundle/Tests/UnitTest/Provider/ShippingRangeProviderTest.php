...
use Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\ShippingWeightRangeInterface;
use Elcodi\Plugin\CustomShippingBundle\Repository\CarrierRepository;
use Elcodi\Plugin\CustomShippingBundle\Resolver\ShippingRangeResolver;
...
class ShippingRangeProviderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->carrierRepository = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Repository\CarrierRepository', [], [], '', false);
        ...
        $this->shippingRangeResolver = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Resolver\ShippingRangeResolver', [], [], '', false);
    ...
    public function testIsShippingWeightRangeSatisfiedByCart(
        ...
        $shippingRangeProvider = $this
            ->getMockBuilder('Elcodi\Plugin\CustomShippingBundle\Provider\ShippingRangeProvider')
            ->setMethods([
    ...
    private function getCarrierMock(
        ...
        $carrier = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\CarrierInterface');
    ...
    private function getShippingPriceRangeMock(
        ...
        $priceRange = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface');
    ...
    private function getShippingWeightRangeMock(
        ...
        $shippingRange = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface');
