...
namespace Elcodi\Plugin\CustomShippingBundle\Tests\UnitTest\Resolver;
...
use Elcodi\Plugin\CustomShippingBundle\ElcodiShippingResolverTypes;
...
class ShippingRangeResolverTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $cheapShippingRange = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface');
        ...
        $mediumShippingRange = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface');
        ...
        $expensiveShippingRange = $this->getMock('Elcodi\Plugin\CustomShippingBundle\Entity\Interfaces\ShippingRangeInterface');
