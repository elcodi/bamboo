...
namespace Elcodi\Bridge\VisithorBridgeBundle\DependencyInjection;

use Elcodi\Bundle\CoreBundle\DependencyInjection\Abstracts\AbstractExtension;

/**
 * Class ElcodiVisithorBridgeExtension
 */
class ElcodiVisithorBridgeExtension extends AbstractExtension
{
    /**
     * @var string
     *
     * Extension name
     */
    const EXTENSION_NAME = 'elcodi_visithor_bridge';
