...
namespace Admin\AdminMenuBundle\Controller;
    ...
    EnableableControllerInterface
{
     ...
     *      name = "admin_menu_list_component",
     *      requirements = {
     *          "page" = "\d*",
     *          "limit" = "\d*",
     *      },
     ...
     * @Route(
     *      path = "/component/{id}",
     *      name = "admin_menu_view_component",
     *      requirements = {
     *          "id" = "\d*",
     *      }
     * )
     ...
     * @EntityAnnotation(
     *      class = {
     *          "factory" = "elcodi.core.menu.factory.menu",
     *      },
     *      mapping = {
     *          "id" = "~id~"
     *      }
     ...
     * )
     * @FormAnnotation(
     *      class = "admin_menu_form_type_menu",
     *      name  = "formView",
     *      entity = "entity"
     * )
     */
     ...
     *      name = "admin_menu_edit_component"
     * )
     * @Template
     * @Method({"GET"})
     *
