    ...
    EnableableControllerInterface
{
     ...
     *      name = "admin_currency_exchange_rate_list",
     *      requirements = {
     *          "page" = "\d*",
     *          "limit" = "\d*",
     *      },
     ...
     *      name = "admin_currency_exchange_rate_list_component",
     *      requirements = {
     *          "page" = "\d*",
     *          "limit" = "\d*",
     *      },
    ...
    )
    {
        $paginatorFields = $this
            ->container
            ->getParameter('elcodi.admin.currency.pagination.currency_exchange_rate.fields');
     ...
     * @Route(
     *      path = "/{id}",
     *      name = "admin_currency_exchange_rate_view",
     *      requirements = {
     *          "id" = "\d*",
     *      }
     * )
     ...
     * @Route(
     *      path = "/component/{id}",
     *      name = "admin_currency_exchange_rate_view_component",
     *      requirements = {
     *          "id" = "\d*",
     *      }
     * )
     ...
     * @EntityAnnotation(
     *      class = {
     *          "factory" = "elcodi.core.currency.factory.currency_exchange_rate",
     *      },
     *      mapping = {
     *          "id" = "~id~"
     *      }
     ...
     * @Route(
     *      path = "/new",
     *      name = "admin_currency_exchange_rate_new"
     * )
     * @Template
     * @Method({"GET"})
     */
     ...
     * @Route(
     *      path = "/new/component",
     *      name = "admin_currency_exchange_rate_new_component"
     * )
     * @Template
     * @Method({"GET"})
     *
     ...
     * )
     * @FormAnnotation(
     *      class = "elcodi_admin_currency_exchange_rate_form_type_currency_exchange_rate",
     *      name  = "formView",
     *      entity = "entity"
     * )
     */
     ...
     * @Route(
     *      path = "/save",
     *      name = "admin_currency_exchange_rate_save"
     * )
     * @Method({"POST"})
     *
     * @EntityAnnotation(
    ...
    )
    {
        ...
        return $this->redirectRoute("admin_currency_exchange_rate_view", [
            'id'    =>  $entity->getId(),
        ]);
    }
     ...
     * @Route(
     *      path = "/{id}/edit",
     *      name = "admin_currency_exchange_rate_edit"
     * )
     * @Template
     * @Method({"GET"})
     */
     ...
     *      name = "admin_currency_exchange_rate_edit_component"
     * )
     * @Template
     * @Method({"GET"})
     *
     * @EntityAnnotation(
     *      class = "elcodi.core.currency_exchange_rate.entity.currency_exchange_rate.class",
     *      mapping = {
     *          "id": "~id~",
     *      }
     * )
     ...
     * @Route(
     *      path = "/{id}/update",
     *      name = "admin_currency_exchange_rate_update"
     * )
     * @Method({"POST"})
     *
     * @EntityAnnotation(
     ...
     * @Route(
     *      path = "/{id}/enable",
     *      name = "admin_currency_exchange_rate_enable"
     * )
     * @Method({"POST"})
     *
     * @EntityAnnotation(
     ...
     * @Route(
     *      path = "/{id}/disable",
     *      name = "admin_currency_exchange_rate_disable"
     * )
     * @Method({"POST"})
     *
     * @EntityAnnotation(
     ...
     * @Route(
     *      path = "/{id}/delete",
     *      name = "admin_currency_exchange_rate_delete"
     * )
     * @Method({"GET"})
     *
     * @EntityAnnotation(
