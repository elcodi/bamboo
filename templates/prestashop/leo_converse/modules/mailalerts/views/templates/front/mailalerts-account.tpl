...
<div id="mailalerts_block_account" class="block">
	...
	<ul class="footer_links clearfix">
		<li class="pull-left"><a class="btn btn-outline button button-small btn-sm" href="{$link->getPageLink('my-account', true)|escape:'html'}" title="{l s='Back to Your Account' mod='mailalerts'}"><span><i class="fa fa-user"></i>{l s='Back to Your Account' mod='mailalerts'}</span></a></li>
	</ul>
</div>
