 ...
 */
class Version20151007214911 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE cart (id INT AUTO_INCREMENT NOT NULL, customer_id INT DEFAULT NULL, delivery_address_id INT DEFAULT NULL, billing_address_id INT DEFAULT NULL, quantity INT NOT NULL, ordered TINYINT(1) NOT NULL, shipping_method VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_BA388B79395C3F3 (customer_id), INDEX IDX_BA388B7EBF23851 (delivery_address_id), INDEX IDX_BA388B779D0C0E4 (billing_address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE cart_line (id INT AUTO_INCREMENT NOT NULL, order_line_id INT DEFAULT NULL, cart_id INT NOT NULL, product_currency_iso VARCHAR(3) NOT NULL, currency_iso VARCHAR(3) NOT NULL, product_id INT NOT NULL, variant_id INT DEFAULT NULL, product_amount INT NOT NULL, amount INT NOT NULL, quantity INT NOT NULL, UNIQUE INDEX UNIQ_3EF1B4CFBB01DC09 (order_line_id), INDEX IDX_3EF1B4CF1AD5CDBF (cart_id), INDEX IDX_3EF1B4CF3E76C531 (product_currency_iso), INDEX IDX_3EF1B4CFB3D2E75A (currency_iso), INDEX IDX_3EF1B4CF4584665A (product_id), INDEX IDX_3EF1B4CF3B69A9AF (variant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, manufacturer_id INT DEFAULT NULL, principal_variant_id INT DEFAULT NULL, principal_category_id INT DEFAULT NULL, principal_image_id INT DEFAULT NULL, price_currency_iso VARCHAR(3) DEFAULT NULL, reduced_price_currency_iso VARCHAR(3) DEFAULT NULL, name VARCHAR(255) NOT NULL, sku VARCHAR(255) DEFAULT NULL, slug VARCHAR(255) NOT NULL, short_description VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, show_in_home TINYINT(1) DEFAULT NULL, dimensions VARCHAR(255) DEFAULT NULL, stock INT DEFAULT NULL, price INT DEFAULT NULL, reduced_price INT DEFAULT NULL, height INT NOT NULL, width INT NOT NULL, depth INT NOT NULL, weight INT NOT NULL, images_sort VARCHAR(255) DEFAULT NULL, meta_title VARCHAR(255) DEFAULT NULL, meta_description VARCHAR(255) DEFAULT NULL, meta_keywords VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, enabled TINYINT(1) NOT NULL, INDEX IDX_D34A04ADA23B42D (manufacturer_id), INDEX IDX_D34A04ADE2560A82 (principal_variant_id), INDEX IDX_D34A04AD5740FE34 (principal_category_id), INDEX IDX_D34A04ADA7F1F96B (principal_image_id), INDEX IDX_D34A04AD47018B47 (price_currency_iso), INDEX IDX_D34A04ADEB35D9BE (reduced_price_currency_iso), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE variant_image (variant_id INT NOT NULL, image_id INT NOT NULL, INDEX IDX_45B79B023B69A9AF (variant_id), INDEX IDX_45B79B023DA5256D (image_id), PRIMARY KEY(variant_id, image_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cart_line ADD CONSTRAINT FK_3EF1B4CF3E76C531 FOREIGN KEY (product_currency_iso) REFERENCES currency (iso)');
        ...
        $this->addSql('ALTER TABLE orders ADD CONSTRAINT FK_E52FFDEE3E76C531 FOREIGN KEY (product_currency_iso) REFERENCES currency (iso)');
        ...
        $this->addSql('ALTER TABLE order_line ADD CONSTRAINT FK_9CE58EE13E76C531 FOREIGN KEY (product_currency_iso) REFERENCES currency (iso)');
        ...
        $this->addSql('ALTER TABLE order_line ADD CONSTRAINT FK_9CE58EE13B69A9AF FOREIGN KEY (variant_id) REFERENCES variant (id)');
        ...
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD5740FE34 FOREIGN KEY (principal_category_id) REFERENCES category (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADA7F1F96B FOREIGN KEY (principal_image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD47018B47 FOREIGN KEY (price_currency_iso) REFERENCES currency (iso)');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04ADEB35D9BE FOREIGN KEY (reduced_price_currency_iso) REFERENCES currency (iso)');
        ...
        $this->addSql('ALTER TABLE variant ADD CONSTRAINT FK_F143BFADA7F1F96B FOREIGN KEY (principal_image_id) REFERENCES image (id) ON DELETE SET NULL');
        $this->addSql('ALTER TABLE variant ADD CONSTRAINT FK_F143BFAD47018B47 FOREIGN KEY (price_currency_iso) REFERENCES currency (iso)');
        $this->addSql('ALTER TABLE variant ADD CONSTRAINT FK_F143BFADEB35D9BE FOREIGN KEY (reduced_price_currency_iso) REFERENCES currency (iso)');
        ...
        $this->addSql('ALTER TABLE variant_image ADD CONSTRAINT FK_45B79B023B69A9AF FOREIGN KEY (variant_id) REFERENCES variant (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE variant_image ADD CONSTRAINT FK_45B79B023DA5256D FOREIGN KEY (image_id) REFERENCES image (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE cart_line DROP FOREIGN KEY FK_3EF1B4CF3E76C531');
        ...
        $this->addSql('ALTER TABLE orders DROP FOREIGN KEY FK_E52FFDEE3E76C531');
        ...
        $this->addSql('ALTER TABLE order_line DROP FOREIGN KEY FK_9CE58EE13E76C531');
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD47018B47');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04ADEB35D9BE');
        $this->addSql('ALTER TABLE variant DROP FOREIGN KEY FK_F143BFAD47018B47');
        $this->addSql('ALTER TABLE variant DROP FOREIGN KEY FK_F143BFADEB35D9BE');
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04ADA7F1F96B');
        $this->addSql('ALTER TABLE product_image DROP FOREIGN KEY FK_64617F033DA5256D');
        $this->addSql('ALTER TABLE variant DROP FOREIGN KEY FK_F143BFADA7F1F96B');
        $this->addSql('ALTER TABLE variant_image DROP FOREIGN KEY FK_45B79B023DA5256D');
        ...
        $this->addSql('ALTER TABLE variant_image DROP FOREIGN KEY FK_45B79B023B69A9AF');
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD5740FE34');
        ...
        $this->addSql('DROP TABLE variant_image');
